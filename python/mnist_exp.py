...
if __name__=='__main__':
  ...
  parser.add_argument('--nac', action='store_true', default=False,
                      help='use nac metric')
  parser.add_argument('--deepgini', action='store_true', default=False,
                      help='use deepgini metric')
  parser.add_argument('--tknc', action='store_true', default=False,
                      help='use tknc metric')
  parser.add_argument('--snac', action='store_true', default=False,
                      help='use tknc metric')
  parser.add_argument('--kmnc', action='store_true', default=False,
                      help='use tknc metric')
  parser.add_argument('--nbc', action='store_true', default=False,
                      help='use tknc metric')
